package com.mweser.affordabilitytracker.projection_app;

import java.util.ArrayList;
import java.util.Date;

import com.mweser.affordabilitytracker.projection_app.event_structures.AccountEvent;
import com.mweser.affordabilitytracker.projection_app.event_structures.ExpenseEvent;
import com.mweser.affordabilitytracker.projection_app.event_structures.RecurEvent;
import com.mweser.affordabilitytracker.projection_app.data_operations.ColumnOps;
import com.mweser.affordabilitytracker.projection_app.data_operations.RowOps;
...
//        }
        ...
        for (ArrayList<? extends RecurEvent> list : listArray)
        {
            ...
            for (RecurEvent event : list)
            {
                ...
                for (int index = 0; index < dateList.size(); index++)
                {
                    ...
                    String dateString = DateConversionUtils.dateToString(dateList.get(index));
    ...
    private void declareClassFields()
    {
        ...
        globalStartDate = DateConversionUtils.stringToDate(START_DATE);
        globalEndDate = DateConversionUtils.stringToDate(END_DATE);

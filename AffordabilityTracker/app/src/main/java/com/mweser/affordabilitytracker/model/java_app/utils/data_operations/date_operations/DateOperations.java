...
public class DateOperations {
    ...
    public static Data convertLongArrayToDateArray(Data data, int dateColumn, String dateString) {
        ...
        Date date = DateTypeUtils.stringToDate(dateString);

        for (int rowIndex = 1; rowIndex < data.size(); rowIndex++) {
            date = incrementDate(date, RecurEventSchema.FrequencyType.DAYS, 1);

            data.setValueAt(rowIndex, dateColumn, DateTypeUtils.dateToString(date));
        }
    ...
    public static Data convertMonthYearArrayToLongArray(Data monthYearArray, String startDate,
        ...
        for (int i = 1; i < monthYearArray.size(); i++) {
            ...
            monthYearDate = DateTypeUtils.convertDateStringFormats(monthYearDate,
                    "MMM yyyy",
                    "MM/dd/yyyy");
    ...
    public static String daysBetweenDatesFormatted(String startDateString, String endDateString,
            String format) {
        Date startDate = DateTypeUtils.formattedStringToDate(startDateString, format);
        Date endDate = DateTypeUtils.formattedStringToDate(endDateString, format);
    ...
    public static Date incrementDate(Date date, RecurEventSchema.FrequencyType frequencyType,
            int frequency) {
    ...
    public static Date decrementDate(Date date, RecurEventSchema.FrequencyType frequencyType,
            int frequency) {

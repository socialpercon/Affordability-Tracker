...
import static com.mweser.affordabilitytracker.activity.create_expense.AddExpense.ToggleButtonTypes.EXPENSE;
import static com.mweser.affordabilitytracker.activity.create_expense.AddExpense.ToggleButtonTypes.INCOME;
...
public class AddExpense extends DataEntryActivity
{
    ...
    public AddExpense(Activity activity, Context appContext, Context baseContext)
    {
